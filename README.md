# To-Do List - PHP Database

#### By: Jared Beckler | Epicodus | March 2016

This project was used to get familiar with PHP/Silex/Twig/PHPUnit/PHPMyAdmin and allow the user to categorize and save tasks on a to-do list.
...
* `git clone https://github.com/jaredbeckler/to-do-list` this repository
